...
class ModelTestCase(TestCase):
    ...
    def test_create_model(self):
        ...
        assert UserModel.Meta.connect_timeout_seconds, 60
        assert UserModel.Meta.read_timeout_seconds == 60
        ...
        assert UserModel._connection.connection._connect_timeout_seconds == 60
        assert UserModel._connection.connection._read_timeout_seconds == 60
