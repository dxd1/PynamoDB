...
The time till a timeout exception is thrown when attempting to make a connection.
...
The time till a timeout exception is thrown when attempting to read from a connection.
